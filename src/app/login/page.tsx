...
import { Mail, Lock, Eye, EyeOff, ArrowRight, AlertCircle, ShieldCheck, Truck, Star } from 'lucide-react'
import { signInWithEmailAndPassword, signInWithPopup } from 'firebase/auth'
import { auth, googleProvider } from '@/lib/firebase'

const perks = [
  { icon: ShieldCheck, text: '2-Year warranty on all products' },
  { icon: Truck, text: 'Express delivery across Nigeria' },
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-navy-900">
      ...
      <div className="relative hidden lg:flex lg:w-[45%] xl:w-[40%] flex-col justify-between px-12 pb-12 pt-24 overflow-hidden bg-navy-950">
        ...
        >
          <p className="section-label mb-4">Nigeria&apos;s Premier Tech Store</p>
          ...
          <p className="text-slate-400 leading-relaxed mb-10 max-w-sm">
            Sign in to track orders, manage your wishlist, and get exclusive deals delivered straight to you.
          </p>
        ...
        <div className="flex items-center gap-8 pt-8 border-t border-white/[0.06]">
          {[['500+', 'Products'], ['36', 'States'], ['4.9★', 'Rating']].map(([val, label]) => (
            <div key={label}>
      ...
      <div className="flex-1 flex flex-col min-h-screen lg:min-h-0 lg:overflow-y-auto pt-16">
        ...
        <div className="flex items-center justify-between px-6 pt-4 pb-4 lg:hidden">
          ...
          <Link href="/signup" className="text-sm font-semibold text-emerald-400">Create account</Link>
        </div>
        ...
        <div className="flex-1 flex items-center justify-center px-6 py-10 lg:px-16 xl:px-24">
          ...
          >
            <div className="mb-8">
              ...
              <p className="text-slate-400">Sign in to your ChrisTech account</p>
            </div>
            ...
            <div className="relative mb-6">
              ...
              <div className="relative flex justify-center">
                <span className="bg-navy-900 px-3 text-xs text-slate-500">or continue with email</span>
              </div>
            </div>
